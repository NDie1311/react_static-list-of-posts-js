...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>U.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>U.jsxs("div",{className:"CommentInfo",children:[U.jsx("div",{className:"CommentInfo__name",children:e.name}),U.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),U.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>U.jsx("div",{className:"CommentList",children:e.map(t=>U.jsx(Lc,{comment:t},t.id))}),Mc=({post:e,title:t,body:i,user:n,comments:a})=>{const u=e?e.title:t,o=e?e.body:i,r=e?e.user:n,s=e?e.comments:a;return U.jsxs("div",{className:"PostInfo",children:[U.jsxs("div",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:u}),U.jsxs("p",{children:[" Posted by  ",r?U.jsx(Pc,{user:r}):"Unknown User"]})]}),U.jsx("p",{className:"PostInfo__body",children:o}),U.jsx("hr",{}),s&&s.length>0?U.jsx(Tc,{comments:s}):U.jsx("b",{"data-cy":"NoCommentsMessage"})]})},Rc=({posts:e})=>U.jsx("div",{className:"PostList",children:e.map(t=>U.jsx(Mc,{title:t.title,body:t.body,user:t.user,comments:t.comments},t.id))}),Dc=e=>Nc.find(t=>t.id===e)||null,jc=e=>zc.filter(t=>t.postId===e),Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(U.jsx(Fc,{}));
